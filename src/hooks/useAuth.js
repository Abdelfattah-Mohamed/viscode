...
const ALLOW_DEMO_AUTH = typeof import.meta !== "undefined" && import.meta.env
  ? !!import.meta.env.DEV || String(import.meta.env.VITE_ALLOW_DEMO_AUTH || "").toLowerCase() === "true"
  : false;
...
export function useAuth() {
  ...
  const verifyEmail = async (code) => {
    ...
    if (pendingVerification.clientVerify) {
      ...
      accepted = apiResult.ok || (ALLOW_DEMO_AUTH && isDemoCode(normalized) && (apiResult.demo || !getSupabase()));
